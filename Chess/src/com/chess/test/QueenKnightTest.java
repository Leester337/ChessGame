    ...
    public class QueenKnightTest {
        ...
        /**
         * Add a QueenKnightPiece and make sure it gets possible moves
         * @throws CaptureOwnPieceException
         */
        @Test
        public void testNumberGetPossibleMoves() throws CaptureOwnPieceException {
            Board myBoard = new Board();
            QueenKnightPiece testPiece = new QueenKnightPiece(4, 4, myBoard.getWhite(),
